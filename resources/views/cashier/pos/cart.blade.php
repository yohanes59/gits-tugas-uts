                            ...
                            @forelse ($keranjang as $item)
                                <div class="row py-2">
                                    ...
                                    <div class="col-md-4 mb-4 mb-lg-0">
                                        <div>Nama Produk</div>
                                        <p class="mt-2">
                                            <strong>{{ $products->where('id', $item['product_id'])->first()->name }}</strong>
                                        </p>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-4 mb-lg-0">
                                        ...
                                        <div class="d-flex mb-4 gap-3" style="max-width: 300px">
                                            <div class="form-outline">
                                                ...
                                                <input id="form1" min="0" name="quantity" value="{{ $item['quantity'] }}" type="number" class="form-control" readonly />
                                            </div>
                                            <div class="form-outline">
                                                <label class="form-label" for="form2">Harga</label>
                                                <input id="form2" min="0" name="harga" id="harga" value="{{ $item['total'] }}" type="number" class="form-control" readonly />
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card mb-4 shadow">
                        ...
                        <div class="card-body">
                            <form action="{{ route('checkout') }}" method="POST">
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-end align-items-center">
                                            <input type="number" id="bayar" class="form-control" style="max-width: 100px" min="0">
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <button type="submit" id="bayar-btn" disabled class="btn btn-primary btn-lg btn-block" onclick="payConfirmation()">Bayar</button>
                            </form>
                        </div>
                    </div>
                </div>
